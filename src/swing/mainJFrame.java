...
public class mainJFrame extends JFrame implements MouseListener {
	...
	public static VerificationActionListener verifyPanel;
	public mainJFrame()
	{
	...
	public void initCenterPanel() {
		...
		verifyPanel=new VerificationActionListener(this);
	}
	...
	public void creatVerifyUI() {
		centerPanel.removeAll();
		centerPanel.add(VerificationActionListener.mainSplitPane, "Center");
		centerPanel.updateUI();
	}
	@Override
