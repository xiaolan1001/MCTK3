...
public class GraphExplainATLsK extends MultiGraph {
    private SpriteManager sman;

    public ATLsK_ModelCheckAlg getChecker() {
        return checker;
    }

    public void setChecker(ATLsK_ModelCheckAlg checker) {
        this.checker = checker;
    }

    private ATLsK_ModelCheckAlg checker;

    public GraphExplainATLsK(String id, ATLsK_ModelCheckAlg checker) {
        super(id);
        this.checker = checker;
