...
//		}
	...
	public MCTKFrame()
	{
		...
		Image logoIcon = new ImageIcon(MCTKFrame.class.getClassLoader().getResource("./Icons/logo.png")).getImage();
...
*/
	...
	public void initBackgroundPanel() {
		...
		Icon appendIcon = new ImageIcon(MenuToolBarJPanel.class.getClassLoader().getResource("./Icons/icons8-add-row-24.png"));
...
//		appendSpecButton.setBorder(BorderFactory.createRaisedSoftBevelBorder());
		...
		Icon insertIcon = new ImageIcon(MenuToolBarJPanel.class.getClassLoader().getResource("./Icons/icons8-insert-row-24.png"));
...
//		insertSpecButton.setBorder(BorderFactory.createRaisedSoftBevelBorder());
		...
		Icon delIcon = new ImageIcon(MenuToolBarJPanel.class.getClassLoader().getResource("./Icons/icons8-delete-row-24.png"));
...
//		delSpecButton.setBorder(BorderFactory.createRaisedSoftBevelBorder());
		...
		Icon verifyIcon = new ImageIcon(MenuToolBarJPanel.class.getClassLoader().getResource("./Icons/icons8-search-24.png"));
...
*/
	...
	public JLabel CreateMenuLabel(JLabel jlabel, String text, String name, JPanel jpanel) {
		Icon icon = new ImageIcon(MCTKFrame.class.getClassLoader().getResource("./Icons/" + name + ".png"));
