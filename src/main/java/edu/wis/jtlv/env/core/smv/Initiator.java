...
import edu.wis.jtlv.env.core.smv.eval.temporals.*;
...
public class Initiator {
	...
	public SMVAbstractElementInfo mk_process_var(boolean visible, StringArrayWA var_name,
		...
		return new SMVProcVarInfo(visible, var_name.arr[0], new SMVParsingInfo(input),
				p, is_sync, arg_arr);
	}
...
//		var.visible = visible;
	...
	public void do_creation() throws SMVParseException {
		...
		//LXY: for MAS
		main_proc_info.mk_agent_modules();
		// } catch (SMVParseException e) {
		// Env.do_error(e);
		// }
	...
	public void attachDefine(StringArrayWA def_name, StmtValueArrayWA val)
		...
		//update20170524 MODULE without instance bug
		boolean is_for_define = arrayed_var_names.length>0&&!arrayed_var_names[0].equals(def_name);
