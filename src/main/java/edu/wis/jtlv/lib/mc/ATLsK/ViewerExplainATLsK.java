...
public class ViewerExplainATLsK implements ViewerListener {
    ...
    public void setGraph(GraphExplainATLsK graph) {
        this.graph = graph;
    }

    private GraphExplainATLsK graph;
    SpriteManager spriteMgr;

    public ViewerExplainATLsK(GraphExplainATLsK G) {
