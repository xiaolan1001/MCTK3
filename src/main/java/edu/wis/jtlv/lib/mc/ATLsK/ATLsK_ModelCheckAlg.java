...
public class ATLsK_ModelCheckAlg extends ModelCheckAlgI {
    ...
    public void setGraph(GraphExplainATLsK g) {
        this.graph = g;
    }
    ...
    public ATLsK_ModelCheckAlg(Module design, Spec property) {
        super(design);
        this.property = property;
        visibleVars = design.moduleUnprimeVars();
    }
     ...
     * @param design The design to check.
     */
    public ATLsK_ModelCheckAlg(MCTKFrame mainFrame, Module design) {
        super(design);
...
//			String testerName = specTester.getName();
            x = tester.addVar("X" + (++field_id)); // boolean output variable
