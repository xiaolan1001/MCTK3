...
public class ViewerExplainRTCDLs implements ViewerListener, ActionListener, MouseMotionListener {
    ...
    public ViewerExplainRTCDLs(GraphExplainRTCDLs G) throws SpecException {
        ...
        Image logoIcon = new ImageIcon(MCTKFrame.class.getResource("/Icons/logo.png")).getImage();
...
*/
        ...
        negSpecLabel = new JLabel("The following is a witness of " + RTCDLs_ModelCheckAlg.simplifySpecString(graph.negSpec,false));
        negSpecLabel.setToolTipText(RTCDLs_ModelCheckAlg.simplifySpecString(graph.negSpec,false));
...
*/
        ...
        for (Map.Entry<String, SMVModule> entry : G.negSpecTester.atomTesterSet.entrySet()) {
            ...
            MCTKFrame.consoleOutput(2, "emph", RTCDLs_ModelCheckAlg.simplifySpecString(entry.getKey(),false) + "\n");
            i++;
        }
